...
import {toHex256, toHexLength} from './parser';
import {StarknetChainId, StarknetNetworkName} from './types';
...
export const toStarknetTxHash = (hash: string) => {
  return toHexLength(hash, 64);
};
